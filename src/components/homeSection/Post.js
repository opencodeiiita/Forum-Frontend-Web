...
const Post = () => {
  return (
    <div className=" m-4 h-fit  relative shadow-[0px_4px_10px_rgba(0,0,0,0.25)] rounded-xl px-2">
      ...
      <div className=" inline-block h-fit w-[calc(100%-17vw+32px)] px-4">
        <div className=" w-full h-full relative">
          ...
          <div className="h-fit p-2">
            <button className="bg-[#FFFFFF] text-[#C7D1E3] rounded-md px-2 font-sans mx-2">
              Bitcoin
            </button>
            <button className="bg-[#FFFFFF] text-[#C7D1E3] rounded-md px-2 font-sans mx-2">
              Bitcoin
          ...
          <div className="h-fit  relative">
            ...
            <svg
              className=" absolute top-3 right-[88px]"
              width="25"
              height="25"
              viewBox="0 0 26 26"
              fill="none"
