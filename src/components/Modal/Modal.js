      ...
      <div className="modal-container bg-gray-100 top-0 scale-x-[90%] mx-auto px-6 py-4 rounded-lg shadow-xl overflow-y-auto sm:px-8 sm:py-6 lg:py-7 lg:px-10 xl:px-12">
        ...
        <div className="my-4">
          <div className="text-gray-100 text-lg leading-relaxed">
            <button className="inline-block bg-gray-600 focus:outline-none focus:shadow-outline-gray hover:bg-gray-800 rounded-full px-3 py-1 text-sm font-semibold text-gray-100 mr-2">#tag1</button>
            <button className="inline-block bg-gray-600 focus:outline-none focus:shadow-outline-gray  hover:bg-gray-800 rounded-full px-3 py-1 text-sm font-semibold text-gray-100 mr-2">#tag2</button>
            <button className="inline-block bg-gray-600 focus:outline-none focus:shadow-outline-gray hover:bg-gray-800 rounded-full px-3 py-1 text-sm font-semibold text-gray-100">#tag3</button>
          </div>
        </div>
        <div className="my-4">
        ...
        <div className="flex justify-between mt-6">
          <button
            ...
            className="text-white font-bold py-2 px-4 rounded-xl bg-blue-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue ml-[27rem]"
          >
            Cancel
          </button>
          <button  onClick={()=>{
